...
public class ColourGrading : MonoBehaviour
{
    ...
    public float HueShift; //this is the float variable that controls the hue
    ...
    public float RedChannel = 100.0f; //this is the float variable for the red channel
    public float GreenChannel = 100.0f; //this is the float variable for the green channel
    public float BlueChannel = 100.0f; //this is the float variable for the blue channel
