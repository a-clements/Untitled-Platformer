Shader "Lightweight Render Pipeline/2D/LWRP-Grayscale"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
				...
				main.rgb = lerp(main.rgb, dot(main.rgb, float3(0.3, 0.59, 0.11)), _Saturation);
				main.rgb = ((main.rgb - 0.5f) * max(_Contrast, 0)) + 0.5f;
				main.rgb += _Exposure;
